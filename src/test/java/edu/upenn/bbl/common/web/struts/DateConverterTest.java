...
public class DateConverterTest {
  ...
  private void doTest(String dateStr, DateTypeConverter converter) {
    ...
    java.util.Date utilDate = (java.util.Date) converter.convertFromString(null, new String[] { dateStr },
        java.util.Date.class);
    System.out.println("java.util.Date.toString(): " + utilDate);

    java.sql.Date sqlDate = (java.sql.Date) converter.convertFromString(null, new String[] { dateStr },
        java.sql.Date.class);
    ...
    Assertions.assertEquals(dateStr, utilStr);
    Assertions.assertEquals(dateStr, sqlStr);
  }
