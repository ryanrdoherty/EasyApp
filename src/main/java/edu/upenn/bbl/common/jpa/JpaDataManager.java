...
/**
 * Abstract implementation of DataManager that performs JPA operations within a transaction. Please note this
...
public abstract class JpaDataManager implements DataManager {
  ...
  /**
   * Returns the EntityManagerFactory that will generate EntityManagers used to perform JPA database
   * operations.
   * 
   ...
   * 
   * @param dbUpdater
   *          worker which will perform the actual database operations
   */
  @Override
   ...
   *           if this method is called from anywhere other than inside the doDbTasks method of a subclass of
   *           DbWorker
   */
