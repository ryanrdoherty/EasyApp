...
/**
 * Performs database tasks using a given the operations available on the passed DataManager. Typical usage is
 * to subclass a child of DbWorker inline and perform the required operations inside an overridden doDbTasks
