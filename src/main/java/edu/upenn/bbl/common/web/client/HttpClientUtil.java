...
public class HttpClientUtil {
   ...
   * while the data will be encrypted, it would be easy for a malicious user to fool calling apps into
   * believing they are contacting one server when in fact their requests are being intercepted.
   * 
