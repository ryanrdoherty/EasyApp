...
/**
 * This action should be referred to when a user help button or link is clicked. It takes one parameter,
 * "page", which is the page for which help is desired. The action looks this page up in the help.properties
 * file to find the resource containing helpful information about that specific page. If no mapping or no page
 * exists, the action provides sensible text.
 * 
 * @author rdoherty
 */
