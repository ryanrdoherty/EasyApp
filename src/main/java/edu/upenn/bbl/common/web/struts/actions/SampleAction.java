...
/**
 * This class exists as a simple child of BaseAction to show how little code must be written to implement an
 * action. It can be used as a model for those learning Struts and the BBL Struts framework.
 * 
 * @author rdoherty
 */
