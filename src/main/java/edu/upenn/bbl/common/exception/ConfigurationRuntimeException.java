...
/**
 * Runtime exception used to denote errors occuring during startup and configuration processing. (e.g. bad
 * file format, DB connection failure, start-up JNDI lookup failures).
 * 
 * @author rdoherty
 */
