...
public class PropertyMapLoader {
  ...
  /**
   * Finds and reads the file with the given bundle name and loads properties into a key-value map, which it
   * returns
   * 
   ...
   * 
   * @param map
   *          map of properties to check
   * @param propKeys
   *          array of keys to look for
