...
public class DataFormats {
  ...
  /**
   * Easy way to take the components of a Name and combine them into a human-readable single string. This is
   * in the format "first middle last suffix.description", omitting empty or null fields.
   * 
   * @param name
   *          Name object
