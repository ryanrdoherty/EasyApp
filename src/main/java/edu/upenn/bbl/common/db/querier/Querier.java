...
/**
 * Abstract class which provides an interface allowing callers to look up table and column names in a
 * database. Children should implement the parts of this class that are vendor-specific.
 * 
 * @author rdoherty
 */
public abstract class Querier {
  ...
  protected abstract PreparedStatement getPsForColumnLookup(Connection conn, String tableName)
      throws SQLException;
   ...
   * 
   * @param tableName
   *          name for which to retrieve columns
