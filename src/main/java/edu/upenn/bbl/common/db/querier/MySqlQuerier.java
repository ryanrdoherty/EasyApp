...
public class MySqlQuerier extends Querier {
  ...
  private static final String TABLE_SELECT_SQL = "select table_name from information_schema.tables " +
      "where table_type = 'BASE TABLE' and table_schema != 'test'";

  private static final String COLUMN_SELECT_SQL = "select column_name," + // 1
      "       ordinal_position," + // 2
      "       column_key," + // 3
      "       is_nullable," + // 4
      "       data_type," + // 5
