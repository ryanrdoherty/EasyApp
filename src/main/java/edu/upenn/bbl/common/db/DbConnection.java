...
/**
 * An implementation of <code>java.sql.Connection</code> that adhere's to the general contract for java
 * Connection objects. For example, the user does not need to do anything more than call close() to release
 * this connection. This was necessary to support the Connection API while continuing to use the DbConnection
 * heritage class.
 * 
 * @author rdoherty
 */
