...
/**
 * An extension of PGSimpleDataSource that allows caller to assign settings via a postgresql connection URL,
 * rather than specifying the server name, port and database name separately.
 * 
 * @author rdoherty
 */
