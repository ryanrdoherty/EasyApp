...
/**
 * Encryption utility class provides methods related to string and plain-text encryption. This class uses the
 * <code>java.security.MessageDigest</code> class and thus supports only a subset of the algorithms supported
 * by that class.
 * 
 * @author rdoherty
 */
public class EncryptionUtil {
  ...
  public enum Algorithm {
    ...
    /**
     * @return the string that must be entered into MessageDigest.getInstance() in order to create a valid
     *         digest.
     */
  ...
  /**
   * Encrypts the given plain text using the passed algorithm. The result is then encoded as a Base-64 string
   * and returned.
   * 
   * @param plaintext
   *          text to encrypt
