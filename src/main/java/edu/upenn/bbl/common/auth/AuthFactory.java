...
public class AuthFactory {
  ...
  /**
   * Returns the default Authenticator, which connects to a database using the BBL standard JNDI name under
   * which a data source to the BBL authentication database should be registered.
   * 
   ...
   * 
   * @param config
   *          config for which to create an Authenticator
